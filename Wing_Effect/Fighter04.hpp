class A149_FuselageVapour_FighterJet
{
	...
	//5
	class 5FX_Plane_WingTrail_lowL: 1FX_Plane_WingTrail_lowL
	{
		type = "AAE_BodyTrail_FighterJet_Short";
		position[] = {-2.5,0.2,-3};
		qualityLevel = 0;
	...
	class 5FX_Plane_WingTrail_mediumLL: 4FX_Plane_WingTrail_lowL
	{
		qualityLevel = 1;
		enabled = "accelY interpolate [79.99,80,-1,1]";
	};
	class 5FX_Plane_WingTrail_highL: 4FX_Plane_WingTrail_lowL
	{
		qualityLevel = 2;
		enabled = "accelY interpolate [79.99,80,-1,1]";
	};
