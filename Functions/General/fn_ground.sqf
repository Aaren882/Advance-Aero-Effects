...
_effect = {
	params["_plane","_Particle_Pick","_Depos","_velocity","_speed","_particles","_ParticleShape","_Particle_Settings","_Particle00_Setups","_Particle01_Setups"];

	//Color Picking
	_SurfaceType_Pick = configFile >> "CfgVehicles">> typeOf _plane >> "AAE_Config_Handler" >> _Particle_Pick;

	[_plane,_SurfaceType_Pick,_Depos,_velocity,_speed,_ParticleShape,_Particle_Settings,_Particle00_Setups,_Particle01_Setups] spawn _particles;
};
////////////////////////////////////////////////////////////////////////////////
