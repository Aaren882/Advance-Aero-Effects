params["_plane","_speed","_velocity"];
...
private _particles = {
	...
	private ["_Engine_Offset","_speed"];

	//Math Stuff
	_Engine_Offset = -0.06*_speed;

	//Speed Limitations
	_speed = (_speed max 300) min 500;
...
_effect = {
	...
	//Color Picking
	_SurfaceType_Pick = configOf _plane >> "AAE_Config_Handler" >> _Particle_Pick;
...
_SurfaceType_Pick = _config >> "AAE_Config_Handler" >> _Particle_Pick;
...
[{
	...
	_Depos = _plane modelToWorldVisual [0,-5,0];
