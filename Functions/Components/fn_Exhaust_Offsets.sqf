...
switch (_Exhausts_count) do
{
  ...
  case 1: {
    ...
    _plane setVariable ["AAE_Turbulent_Sources",[_source00]];

    _dis0 = _planePlayer distance _source00;
    _planePlayer setVariable ["AAE_Turbulent_Source_Distance",[_dis0]];
  };
  case 2: {
    _source00 = _plane modelToWorldVisual [(_engine1 # 0), (_engine1 # 1)+(-10-turbulent_sdr),(_engine1 # 2)];
    _source01 = _plane modelToWorldVisual [(_engine2 # 0), (_engine2 # 1)+(-10-turbulent_sdr),(_engine2 # 2)];
    _plane setVariable ["AAE_Turbulent_Sources",[_source00,_source01]];

    _dis0 = _planePlayer distance _source00;
    _dis1 = _planePlayer distance _source01;
    _planePlayer setVariable ["AAE_Turbulent_Source_Distance",[_dis0,_dis1]];
  };
  case 3: {
    _source00 = _plane modelToWorldVisual [(_engine1 # 0), (_engine1 # 1)+(-10-turbulent_sdr),(_engine1 # 2)];
    _source01 = _plane modelToWorldVisual [(_engine2 # 0), (_engine2 # 1)+(-10-turbulent_sdr),(_engine2 # 2)];
    _source02 = _plane modelToWorldVisual [(_engine3 # 0), (_engine3 # 1)+(-10-turbulent_sdr),(_engine3 # 2)];
    _plane setVariable ["AAE_Turbulent_Sources",[_source00,_source01,_source02]];

    _dis0 = _planePlayer distance _source00;
    _dis1 = _planePlayer distance _source01;
    _dis2 = _planePlayer distance _source02;
    _planePlayer setVariable ["AAE_Turbulent_Source_Distance",[_dis0,_dis1,_dis2]];
  };
  case 4: {
    _source00 = _plane modelToWorldVisual [(_engine1 # 0), (_engine1 # 1)+(-10-turbulent_sdr),(_engine1 # 2)];
    _source01 = _plane modelToWorldVisual [(_engine2 # 0), (_engine2 # 1)+(-10-turbulent_sdr),(_engine2 # 2)];
    ...
    _planePlayer setVariable ["AAE_Turbulent_Source_Distance",[_dis0,_dis1,_dis2,_dis3]];
  };
};
